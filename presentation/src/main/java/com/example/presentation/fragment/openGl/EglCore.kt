...
class EglCore @JvmOverloads constructor(_sharedContext: EGLContext? = null, flags: Int = 0) {
     ...
     *
     *
     * @param _sharedContext The context to share, or null if sharing is not desired.
     ...
     */
    init {
        var sharedContext = _sharedContext
        if (mEGLDisplay !== EGL14.EGL_NO_DISPLAY) {
